...
- All changes to CI workflow helper commands should be made in the embedded Python script within action.yml.
...
This repository provides a composite GitHub Action with helper commands for CI workflows.
