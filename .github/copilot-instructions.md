...
- This is a composite GitHub Action that embeds Python logic directly in
  action.yml.
- All changes to CI workflow helper commands should be made in the embedded
...
This repository provides a composite GitHub Action with helper commands for CI
workflows.
